  ...
  return (
    ...
    >
      <Container>
        ...
        <div 
          className="relative max-w-5xl mx-auto group outline-none"
          ...
          <div className="relative aspect-[16/9] md:aspect-[21/9] lg:aspect-[24/9] h-[500px] overflow-hidden rounded-2xl border border-white/10 bg-black/40 backdrop-blur-sm shadow-2xl">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="relative w-full h-1/3 md:h-full md:w-[35%] flex flex-col justify-center p-6 md:p-10 border-t md:border-t-0 md:border-l border-white/10 bg-white/5 backdrop-blur-md">
                  <motion.h3 
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/50 text-white hover:bg-white/20 transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-white/50 z-10"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 p-2 rounded-full bg-black/50 text-white hover:bg-white/20 transition-all opacity-0 group-hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-white/50 z-10"
