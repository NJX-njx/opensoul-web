...
read_when:
  - You want Zalo Personal (unofficial) support in OpenSoul
...
Zalo Personal support for OpenSoul via a plugin, using `zca-cli` to automate a normal Zalo user account.
