...
read_when:
  - You are building a OpenSoul plugin
...
Every plugin **must** ship a `opensoul.plugin.json` file in the **plugin root**.
OpenSoul uses this manifest to validate configuration **without executing plugin
