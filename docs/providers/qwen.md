---
summary: "Use Qwen OAuth (free tier) in OpenSoul"
read_when:
  - You want to use Qwen with OpenSoul
...
If you already logged in with the Qwen Code CLI, OpenSoul will sync credentials
