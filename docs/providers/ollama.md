---
summary: "Run OpenSoul with Ollama (local LLM runtime)"
read_when:
  - You want to run OpenSoul with local models via Ollama
...
3. Enable Ollama for OpenSoul (any value works; Ollama doesn't require a real key):
