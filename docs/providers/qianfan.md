---
summary: "Use Qianfan's unified API to access many models in OpenSoul"
read_when:
...
3. OpenSoul installed on your system
...
4. Copy the API key for use with OpenSoul

## CLI setup

```bash
opensoul onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenSoul Configuration](/gateway/configuration)
