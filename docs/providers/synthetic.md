---
summary: "Use Synthetic's Anthropic-compatible API in OpenSoul"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenSoul registers it as the
...
Note: OpenSoul's Anthropic client appends `/v1` to the base URL, so use
