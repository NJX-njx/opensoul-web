...
You can point OpenSoul at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenSoul
...
- [Anthropic provider](/providers/anthropic) - Native OpenSoul integration with Claude setup-token or API keys
