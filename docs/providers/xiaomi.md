---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenSoul"
read_when:
  - You want Xiaomi MiMo models in OpenSoul
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenSoul uses
