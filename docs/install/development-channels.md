...
OpenSoul ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OpenSoul also aligns
the install method:
...
When you switch channels with `opensoul update`, OpenSoul also syncs plugin sources:
