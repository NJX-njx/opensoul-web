...
Deploy OpenSoul on Northflank with a one-click template and finish setup in your browser.
...
1. Click [Deploy OpenSoul](https://northflank.com/stacks/deploy-opensoul) to open the template.
