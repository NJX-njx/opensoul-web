---
summary: "Automated, hardened OpenSoul installation with Ansible, Tailscale VPN, and firewall isolation"
read_when:
...
The recommended way to deploy OpenSoul to production servers is via **[opensoul-ansible](https://github.com/opensoul/opensoul-ansible)** — an automated installer with security-first architecture.
...
> **📦 Full guide: [github.com/opensoul/opensoul-ansible](https://github.com/opensoul/opensoul-ansible)**
>
...
The Ansible installer sets up OpenSoul for manual updates. See [Updating](/install/updating) for the standard update flow.
...
- [Security Architecture](https://github.com/opensoul/opensoul-ansible/blob/main/docs/security.md)
- [Technical Details](https://github.com/opensoul/opensoul-ansible/blob/main/docs/architecture.md)
- [Troubleshooting Guide](https://github.com/opensoul/opensoul-ansible/blob/main/docs/troubleshooting.md)

## Related

- [opensoul-ansible](https://github.com/opensoul/opensoul-ansible) — full deployment guide
