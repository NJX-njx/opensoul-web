...
See [Gateway runbook](/gateway/index) for the derived port mapping (gateway/browser/canvas).
...
- Templates like <code v-pre>{{messages[0].subject}}</code> read from the payload.
