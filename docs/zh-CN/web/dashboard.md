...
- [Web 界面](/web/index) 了解绑定模式和安全注意事项。
...
- **非 localhost**：使用 Tailscale Serve（如果 `gateway.auth.allowTailscale: true` 则无需 token）、带 token 的 tailnet 绑定，或 SSH 隧道。参见 [Web 界面](/web/index)。
