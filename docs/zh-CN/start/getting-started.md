...
如果你想要更深入的参考页面，跳转到：[向导](/start/wizard)、[设置](/start/setup)、[配对](/channels/pairing)、[安全](/gateway/security/index)。
...
安装程序选项（安装方法、非交互式、从 GitHub）：[安装](/install/index)。
...
- iOS/Android 节点（Canvas/相机/语音）：[节点](/nodes/index)
