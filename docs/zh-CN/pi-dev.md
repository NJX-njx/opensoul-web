...
本指南总结了在 OpenSoul 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenSoul 状态目录下。默认为 `~/.opensoul`。如果设置了 `OPENSOUL_STATE_DIR`，则使用该目录。
...
- https://docs.opensoul.ai/testing
- https://docs.opensoul.ai/start/getting-started
