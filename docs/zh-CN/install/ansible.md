...
将 OpenSoul 部署到生产服务器的推荐方式是通过 **[opensoul-ansible](https://github.com/NJX-njx/opensoul-ansible)** — 一个安全优先架构的自动化安装程序。
...
> **📦 完整指南：[github.com/opensoul/opensoul-ansible](https://github.com/NJX-njx/opensoul-ansible)**
>
...
# 2. 克隆仓库
git clone https://github.com/NJX-njx/opensoul-ansible.git
cd opensoul-ansible
...
- [安全架构](https://github.com/NJX-njx/opensoul-ansible/blob/main/docs/security.md)
- [技术详情](https://github.com/NJX-njx/opensoul-ansible/blob/main/docs/architecture.md)
- [故障排除指南](https://github.com/NJX-njx/opensoul-ansible/blob/main/docs/troubleshooting.md)

## 相关内容

- [opensoul-ansible](https://github.com/NJX-njx/opensoul-ansible) — 完整部署指南
