...
OpenSoul treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.opensoul/settings/voicewake.json`

Shape:

```json
{ "triggers": ["opensoul", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
