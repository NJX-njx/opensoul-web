...
OpenSoul has two separate “streaming” layers:
...
When block streaming is enabled, OpenSoul can **merge consecutive block chunks**
...
When draft streaming is active, OpenSoul disables block streaming for that reply to avoid double-streaming.
