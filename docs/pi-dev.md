...
This guide summarizes a sane workflow for working on the pi integration in OpenSoul.
...
- Trigger the agent directly:
  - `pnpm opensoul agent --message "Hello" --thinking low`
...
State lives under the OpenSoul state directory. Default is `~/.opensoul`. If `OPENSOUL_STATE_DIR` is set, use that directory instead.

To reset everything:

- `opensoul.json` for config
...
- [https://docs.opensoul.ai/testing](https://docs.opensoul.ai/testing)
- [https://docs.opensoul.ai/start/getting-started](https://docs.opensoul.ai/start/getting-started)
