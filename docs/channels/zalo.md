...
- Install via CLI: `opensoul plugins install @opensoul/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `opensoul plugins install ./extensions/zalo`
   - From npm (if published): `opensoul plugins install @opensoul/zalo`
...
- Approve via:
  - `opensoul pairing list zalo`
  - `opensoul pairing approve zalo <CODE>`
...
- Example: `opensoul message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `opensoul channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `opensoul logs --follow`
